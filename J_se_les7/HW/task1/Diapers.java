...
public class Diapers extends KidProd {
    ...
    Diapers(String name, int price, int amount, String unit, int minAge, String hypoallergenic, int size,
            int minimalAge, int maxAge, String type) {
    ...
    public String toString() {
        return String.format("%sSize:%d\nMinimal Age:%d\nMaximal Age:%d\nType:%s\n", super.toString(), size, minimalAge,
                maxAge, type);
    }
}
